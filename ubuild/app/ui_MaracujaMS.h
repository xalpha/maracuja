...
**
** Created: Wed Apr 10 09:12:24 2013
...
public:
    ...
    QPushButton *hide_spectrum1_button;
    QGroupBox *groupBox_6;
    QVBoxLayout *verticalLayout_11;
    QPushButton *load_spectrum2_button;
    QPushButton *show_spectrum2_button;
    QPushButton *hide_spectrum2_button;
    QPushButton *on_add_dummy_spectra_button;
    QPushButton *multiply_spectra_button;
    QPushButton *apply_spectrum1_to_image_button;
    ...
    void setupUi(QMainWindow *MaracujaMS)
    {
        ...
        hide_spectrum1_button = new QPushButton(groupBox_5);
        hide_spectrum1_button->setObjectName(QString::fromUtf8("hide_spectrum1_button"));

        verticalLayout_9->addWidget(hide_spectrum1_button);
        ...
        hide_spectrum2_button = new QPushButton(groupBox_6);
        hide_spectrum2_button->setObjectName(QString::fromUtf8("hide_spectrum2_button"));

        verticalLayout_11->addWidget(hide_spectrum2_button);


        verticalLayout_10->addWidget(groupBox_6);

        on_add_dummy_spectra_button = new QPushButton(tab_4);
        on_add_dummy_spectra_button->setObjectName(QString::fromUtf8("on_add_dummy_spectra_button"));

        verticalLayout_10->addWidget(on_add_dummy_spectra_button);
        ...
        apply_spectrum1_to_image_button = new QPushButton(tab_4);
        apply_spectrum1_to_image_button->setObjectName(QString::fromUtf8("apply_spectrum1_to_image_button"));

        verticalLayout_10->addWidget(apply_spectrum1_to_image_button);
    ...
    void retranslateUi(QMainWindow *MaracujaMS)
    {
        ...
        hide_spectrum1_button->setText(QApplication::translate("MaracujaMS", "Hide Spectrum 1", 0, QApplication::UnicodeUTF8));
        ...
        hide_spectrum2_button->setText(QApplication::translate("MaracujaMS", "Hide Spectrum 2", 0, QApplication::UnicodeUTF8));
        on_add_dummy_spectra_button->setText(QApplication::translate("MaracujaMS", "Dummy Data for Spectrum 1,2", 0, QApplication::UnicodeUTF8));
        multiply_spectra_button->setText(QApplication::translate("MaracujaMS", "Multiply Spectra", 0, QApplication::UnicodeUTF8));
        apply_spectrum1_to_image_button->setText(QApplication::translate("MaracujaMS", "Apply Spectrum1 to Image", 0, QApplication::UnicodeUTF8));
